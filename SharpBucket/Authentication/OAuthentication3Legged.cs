...
//		public override T GetResponse<T>(string url, HttpMethod method, T body, Dictionary<string, object> requestParameters)
//		{
//			if (client == null)
//			{
...
//		{
//			var request = new RestRequest(requestUrl, HttpMethod.POST);
