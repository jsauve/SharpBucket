using PortableBitBucketClient.V1.EndPoints;

namespace PortableBitBucketClient.V1
{
	public sealed class BitBucketClientV1 : BitBucketClient
	{
		/// <summary>
		...
		/// </summary>
		public BitBucketClientV1(string token = null) : base("https://bitbucket.org/api/1.0/", token) { }
